...
*_Seputar bot & lainnya_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin : 0851-7322-6065_
...
const gurbot = '6285173226065@s.whatsapp.net'
...
case 'sc': case 'script':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
let text_buysc =`*_Mau scriptnya?_*
...
var bg_lexxy = '6285173226065@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by FallGnZ-Bot' })
}
console.log(feta)
}
break
...
var opt = { packname: 'Gurbot MD', author: 'By FallGnZ' }
